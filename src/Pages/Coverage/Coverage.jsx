  ...
  return (
    <div>
      <div className="w-11/12 mx-auto space-y-5 mt-20">
        <h1 className="text-4xl font-bold text-primary">We are available in 64 districts</h1>
        {/* SEARCH BAR */}
          ...
          <div className="flex w-full max-w-sm">
            ...
            <div className="relative flex-1">
              ...
              <input
                type="search"
                name="location"
                className="w-full h-11 pl-10 pr-4 border border-primary rounded-l-full outline-none"
