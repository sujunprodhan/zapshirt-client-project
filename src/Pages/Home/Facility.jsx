    ...
    <div>
      <div>
        <div className="w-11/12 mx-auto flex items-center space-y-5 p-5 bg-white rounded-md mb-5 mt-20 shadow-xl">
          <img src={img} alt="" />
          <div className="h-30 border-l  border-gray-300 ml-20 border-dashed border-r-amber-500"></div>
        ...
        <div className=" w-11/12 mx-auto flex gap-5 items-center p-5 bg-white rounded-md mb-5 shadow-xl">
          <img src={img2} alt="" className="border-dashed border-r  border-gray-400 px-10" />
          <div className="ml-15 space-y-2">
        ...
        <div className="w-11/12 mx-auto flex gap-5 items-center p-5 bg-white rounded-md shadow-xl mb-20">
          <img src={img2} alt="" className="border-dashed border-r px-10 border-gray-400" />
          <div className="ml-15  space-y-2">
